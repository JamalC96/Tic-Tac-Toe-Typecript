...
class App extends React.Component<{}, IState> { 
  ...
  public checkIfGameIsOver = (board: Player[]) => {
    ...
    else if (board[2] === board[4] && board[4] === board[5] && board[5] !== Player.None) {
      return board[2]
    }
...
return <div className="cell" onClick={this.createOnClickHandler(index)} data-player={board[index]}/>
  ...
  public renderStatus = () => {
    ...
    const winningText = gameIsWon !== Player.None ? 'Player won' : 'The game is a draw!'
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <h1>Tic Tac Toe Using React Typescript </h1>
      </header>
